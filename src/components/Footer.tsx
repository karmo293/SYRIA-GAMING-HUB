          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 w-full max-w-2xl">
            ...
            <div>
              ...
              <div className="flex justify-center gap-4">
                <a 
                  href="https://discord.gg/buXkrtK4s" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#5865F2] hover:text-white transition-all group"
                  title="Discord"
                >
