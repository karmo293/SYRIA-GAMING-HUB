    ...
    <>
      ...
      >
        ...
        <div className="mt-5 flex items-center justify-between gap-4 px-2">
          {/* Name below picture */}
          <h3 className="text-xl font-black uppercase italic text-white line-clamp-1 leading-none group-hover:text-cyan-400 transition-colors">
            {item.title}
          </h3>
      ...
      <ConfirmationModal
        ...
        title="تأكيد الإضافة"
        message={`هل تريد حقاً إضافة "${item.title}" إلى سلة التسوق؟`}
        confirmText="نعم، أضف"
        cancelText="إلغاء"
      />
    </>
